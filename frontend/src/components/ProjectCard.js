  ...
  if (loading) {
    return (
      <div className="text-center my-5">
        <p>Fetching projects from backend... Please wait if the server was inactive.</p>
  ...
  return (
    <>
      {projects.map((project, index) => {
        ...
        return (
          <div key={index} className="card h-100 shadow-sm hover-shadow border-0" style={{ transition: '0.3s' }}>
            ...
            <div className="card-footer d-flex justify-content-between align-items-center bg-white border-0">
              ...
              <button className="btn btn-link text-decoration-none" onClick={() => setOpen(index)}>
                Read more
              </button>
            </div>
            ...
            {open === index && (
              <div className="modal-backdrop-custom" role="dialog" aria-modal="true">
                <div className="modal-custom">
                  <button className="close-btn btn btn-light" onClick={() => setOpen(null)} aria-label="Close">×</button>
                  ...
                  <div className="d-flex justify-content-end">
                    ...
                    <button className="btn btn-outline-secondary ms-2" onClick={() => setOpen(null)}>Close</button>
                  </div>
                </div>
              </div>
            )}
